export default {
  "https://www.budgetbytes.com/southwest-steak-bowls/": {
    ...
    fiveStarRating: 4.87,
    source: {
      recipeUrl: "https://www.budgetbytes.com/southwest-steak-bowls/",
      source: "BudgetBytes"
    }
  },
  "https://www.allrecipes.com/recipe/103535/blackened-tuna-steaks-with-mango-salsa/": {
    ...
    fiveStarRating: 4.83881568908691,
    footnote: [],
    source: {
      recipeUrl:
        "https://www.allrecipes.com/recipe/103535/blackened-tuna-steaks-with-mango-salsa/",
  ...
  "https://www.allrecipes.com/recipe/223042/chicken-parmesan/": {
    ...
    fiveStarRating: 4.81679391860962,
    footnote: [
      "Cook's Note:",
  ...
  "https://www.allrecipes.com/recipe/9044/tomato-chicken-parmesan/": {
    ...
    fiveStarRating: 4.64360952377319,
    footnote: [
      "Tip",
      "Aluminum foil can be used to keep food moist, cook it evenly, and make clean-up easier."
    ],
  ...
  "https://www.allrecipes.com/recipe/15003/oven-fried-parmesan-chicken/": {
    ...
    fiveStarRating: 4.64790439605713,
    footnote: [
      "Tip",
      "Aluminum foil can be used to keep food moist, cook it evenly, and make clean-up easier."
    ],
  ...
  "https://www.allrecipes.com/recipe/229099/breaded-parmesan-ranch-chicken/": {
    ...
    fiveStarRating: 4.64808368682861,
    footnote: [
      "Tip",
  ...
  "https://www.budgetbytes.com/parmesan-pepper-kale-pasta/": {
    ...
    fiveStarRating: 4.8,
    source: {
      recipeUrl: "https://www.budgetbytes.com/parmesan-pepper-kale-pasta/",
      source: "BudgetBytes"
    }
  },
  ...
  "https://www.budgetbytes.com/quick-garlic-parmesan-broccoli/": {
    ...
    fiveStarRating: 4.78,
    source: {
      recipeUrl: "https://www.budgetbytes.com/quick-garlic-parmesan-broccoli/",
      source: "BudgetBytes"
    }
  },
  "https://www.budgetbytes.com/garlic-parmesan-kale-pasta/": {
    ...
    fiveStarRating: 4.94,
    source: {
      recipeUrl: "https://www.budgetbytes.com/garlic-parmesan-kale-pasta/",
      source: "BudgetBytes"
    }
  }
};
